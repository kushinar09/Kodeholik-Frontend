...
export default function SubmissionDetail({
  ...
  return (
    <div className="h-full bg-background flex flex-col overflow-hidden">
      {/* Replace the current outer div that has overflow-auto */}
      <div className="flex-1 overflow-auto no-scrollbar p-4">
        <div className="w-full max-w-4xl mx-auto p-4 space-y-4">
          ...
          <div className="flex items-center">
            <div className="w-full flex items-center justify-between gap-2">
              <div className="flex items-center justify-between gap-2">
                ...
                {submitted && submitted.noTestcase != null && submitted.noSuccessTestcase != null && (
              ...
              <div className="flex">
                ...
                {submitted && submitted.status && submitted.status.toLowerCase() === "success" && (
                  <div>
                    <Button className="h-12 font-bold ml-4 hover:bg-green-400">
                      <svg
                        className="!h-6 !w-6 text-black mr-1"
                        viewBox="0 0 24 24"
                        strokeWidth="2"
                    ...
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent className="max-w-80 p-4 text-sm bg-white text-black" side="bottom">
                          <p>The time taken to execute the submitted code in milliseconds.</p>
                        </TooltipContent>
                      </Tooltip>
                    </div>
          ...
          {submitted && submitted.status !== "Success" && submitted.message && (
          ...
          {submitted && submitted.inputWrong && (
