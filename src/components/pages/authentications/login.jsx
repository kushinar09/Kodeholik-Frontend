            ...
            <form className={cn("flex flex-col gap-6")} onSubmit={handleLoginSubmit}>
              ...
              <div className="grid gap-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Button type="button" onClick={handleLoginGoogle} variant="outline" className="w-full">
                  ...
                  <Button type="button" onClick={handleLoginGithub} variant="outline" className="w-full">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
