...
function CourseForm({ course }) {
  ...
  return (
    <form
      ...
      className="max-w-7xl mx-auto bg-gray-900/40 p-6 rounded-xl border border-gray-800 shadow-lg"
    >
      {error && (
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1 space-y-5">
          <Input
            ...
            placeholder="Title"
            required
            className="w-full bg-gray-800/50 text-white border-gray-700 focus:ring-2 focus:ring-primary focus:border-transparent"
          />
          <Textarea
            name="description"
            ...
            required
            className="w-full h-40 bg-gray-800/50 text-white border-gray-700 focus:ring-2 focus:ring-primary focus:border-transparent"
          />

          {/* Collapsible topics section */}
          <Collapsible open={isTopicsOpen} onOpenChange={setIsTopicsOpen}>
            <CollapsibleTrigger asChild>
              <div className="flex items-center justify-between w-full rounded-lg p-2 bg-gray-800/50 border border-gray-700 transition-colors hover:bg-gray-700/50 cursor-pointer">
      ...
      <div className="flex justify-end space-x-4 pt-6 mt-6 border-t border-gray-800">
        ...
        <Button
          type="submit"
          className="bg-primary text-black font-bold hover:bg-primary/90 transition-colors"
        >
