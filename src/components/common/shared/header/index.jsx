...
export default function HeaderSection({ currentActive = "Problems" }) {
  return (
    <div className="z-10 w-full sticky top-0 px-36 pt-4 pb-2 bg-primary-bg">
      ...
      <nav className="relative flex items-center justify-between p-4 bg-bg-card rounded-2xl">
        <div className="flex items-center space-x-6">
          ...
          <Link to="/" className={`rounded-md px-4 py-2 ${currentActive === "problems" ? "bg-primary text-black font-bold" : "hover:text-white text-primary"}`}>
            Problems
          </Link>
          <Link to="/exam" className={`rounded-md px-4 py-2 ${currentActive === "exams" ? "bg-primary text-black font-bold" : "hover:text-white text-primary"}`}>
            Examination
          </Link>
          ...
          <Link to="/courses" className={`rounded-md px-4 py-2 ${currentActive === "courses" ? "bg-primary text-black font-bold" : "hover:text-white text-primary"}`}>
            Courses
          </Link>
        </div>
