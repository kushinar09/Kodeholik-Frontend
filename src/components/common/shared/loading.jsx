...
export default function LoadingScreen({ loadingText = "Loading..." }) {
  ...
  return (
    <div className="z-20 fixed inset-0 bg-bg-primary/50 backdrop-blur-md flex items-center justify-center">
      <div className="relative">
        {/* Terminal window frame */}
        <motion.div
          className="w-[300px] h-[150px] bg-bg-card rounded-lg p-4 relative overflow-hidden"
        ...
        >
          ...
          {/* Code symbols */}
          <motion.div
            className="text-primary text-xl absolute top-6 right-4 -translate-y-1/2"
          ...
          <div className="flex flex-col gap-1 justify-center items-center h-[70px]">
            ...
            >
              {text || "\u00A0"}
              <motion.span
                className="absolute -right-[4px] top-1 w-[2px] h-[20px] bg-primary"
                animate={{ opacity: [1, 0] }}
